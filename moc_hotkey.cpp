/****************************************************************************
** Meta object code from reading C++ file 'hotkey.hpp'
**
...
#error "The header file 'hotkey.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Hotkey_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Hotkey_t qt_meta_stringdata_Hotkey = {
    {
QT_MOC_LITERAL(0, 0, 6), // "Hotkey"
...
QT_INIT_METAOBJECT const QMetaObject Hotkey::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Hotkey.data,
    qt_meta_data_Hotkey,
    qt_static_metacall,
    nullptr,
    nullptr
